...
- Construir una App utlizando TypeScript, TypeORM, PostgreSQL, Express, React, Redux, Node y CSS puro.
...
1.  El Repositorio se crea desde 0

## BoilerPlate

El repositorio debe contar con dos carpetas: `api` y `client`. En estas carpetas estará el código del back-end y el front-end respectivamente.
